                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="text-lg font-bold text-green-600">
                        {formatPercentage(
                          candidate.trend_indicators.max_improvement_rate
                        )}
                      </div>
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold text-blue-600">
                        {formatPercentage(
                          candidate.trend_indicators.avg_improvement_rate
                        )}
                      </div>
                      <div className="text-xs text-gray-500">
                        Avg Improvement
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold text-purple-600">
                        {formatPercentage(
                          candidate.trend_indicators.trend_consistency
                        )}
                      </div>
                    ...
                    <div className="text-center">
                      <div className="text-lg font-bold text-orange-600">
                        {formatPercentage(
                          candidate.statistical_significance.confidence_level
                        )}
                      </div>
                      ...
                      {isHitter ? (
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_batting_avg
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_obp
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_slugging
                              )}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_era,
                                2
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_whip,
                                2
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span>
                              {formatStat(
                                candidate.baseline_stats_summary.avg_k9,
                                1
                              )}
                            </span>
                          </div>
                      ...
                      {isHitter ? (
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_batting_avg
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_obp
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_slugging
                              )}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="space-y-1 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_era,
                                2
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_whip,
                                2
                              )}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-700">
                              {formatStat(
                                candidate.recent_stats_summary.avg_k9,
                                1
                              )}
                            </span>
                          </div>
                ...
                <div className="bg-blue-50 rounded-lg p-3">
                  ...
                  <div className="text-sm text-blue-700">
                    <p>
                      ...
                      consistency across{' '}
                      <strong>{candidate.trend_indicators.data_points}</strong>{' '}
                      data points.
                      {candidate.statistical_significance.confidence_level >
                        0.8 &&
