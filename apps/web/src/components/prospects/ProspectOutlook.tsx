        ...
        >
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L9 7v3m-3 10h3m-3 0h3"
            />
          </svg>
        </button>
        <button
        ...
        >
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth={2}
              d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.736 3h4.018c.163 0 .326.02.485.06L17 4m-7 10v5a2 2 0 002 2h.095c.5 0 .905-.405.905-.905 0-.714.211-1.412.608-2.006L15 17v-3m-6-10h3m6 0h-3"
            />
          </svg>
        </button>
      </div>
...
export default function ProspectOutlook({
  prospectId,
  compact = false,
}: ProspectOutlookProps) {
  const {
    data: outlook,
    loading,
    error,
    refetch,
  } = useProspectOutlook(prospectId);
  ...
  if (loading) {
    return (
      <div
        className={`rounded-lg border border-gray-200 bg-white ${compact ? 'p-4' : 'p-6'}`}
      >
    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 text-sm">
          No outlook available for this prospect
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className={`prose prose-sm max-w-none ${compact ? 'text-sm' : ''}`}>
        <p className="text-gray-800 leading-relaxed">{outlook.narrative}</p>
      </div>
      ...
      {!compact && outlook.quality_metrics && (
        <div className="mt-4">
          ...
          >
            <span>
              Quality Score: {outlook.quality_metrics.quality_score.toFixed(0)}
              /100
            </span>
            <svg
        ...
        <>
          ...
          <div className="mt-3 pt-3 border-t border-gray-100">
            <div className="flex items-center justify-between text-xs text-gray-500">
              ...
              <span>Template {outlook.template_version}</span>
            </div>
          </div>
        </>
      )}
