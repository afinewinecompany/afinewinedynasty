...
async def get_pitcher_games(session: aiohttp.ClientSession, pitcher_id: int) -> List[Dict]:
    """Get all games for a pitcher in 2025"""
...
async def collect_pitcher_data(session: aiohttp.ClientSession, pitcher_id: int, pitcher_name: str, org: str) -> int:
    """Collect all 2025 pitches for a pitcher"""
...
def main():
    print("=" * 80)
    print("PITCHER DATA COLLECTION - 2025 SEASON")
    ...
    try:
        ...
        print(f"\nFound {len(all_pitchers)} pitchers to process for 2025")
        ...
        print(f"Current 2025: {pitchers} pitchers, {pitches:,} pitches")

        print(f"\n=== STARTING 2025 COLLECTION ===\n")
        ...
        for i, batch in enumerate(batches, 1):
            ...
            if i % 10 == 0:
                ...
                """)
                pitchers, pitches = cur.fetchone()
                print(f"  2025 in DB: {pitchers} pitchers, {pitches:,} pitches")

        print("\n" + "=" * 80)
        print("2025 COLLECTION COMPLETE")
        print("=" * 80)
        ...
        """)
        pitchers, pitches = cur.fetchone()
        print(f"\n2025 Final: {pitchers} pitchers, {pitches:,} pitches")
