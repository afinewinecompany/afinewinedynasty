...
class ProspectDataAuditor:
    ...
    async def audit_milb_game_logs(self):
        ...
        print("\n[INFO] Auditing MILB_GAME_LOGS table...")
        ...
        batting_completeness = await self.conn.fetchrow("""
            SELECT
                ...
                COUNT(CASE WHEN on_base_pct IS NOT NULL THEN 1 END) as with_obp,
                COUNT(CASE WHEN slugging_pct IS NOT NULL THEN 1 END) as with_slg,
    ...
    async def audit_pitch_data(self):
        ...
        print("\n[INFO] Auditing PITCH-BY-PITCH data...")
    ...
    async def audit_hype_data(self):
        ...
        try:
            ...
            print(f"  -> Player hype table not available: {e}")
        ...
        try:
            ...
            print(f"  -> Social mentions table not available: {e}")
        ...
        try:
            ...
            print(f"  -> Media articles table not available: {e}")
        ...
        if hype_stats:
            ...
            if hype_stats['avg_hype_score']:
                print(f"  -> Average hype score: {hype_stats['avg_hype_score']:.1f}")
        else:
            print("  -> No hype data available")

    async def audit_data_coverage(self):
        """Analyze overall data coverage for prospects."""
        print("\n[INFO] Analyzing OVERALL DATA COVERAGE...")
...
"""
    ...
    async def generate_csv_summary(self):
        ...
        print(f"\n[INFO] CSV summary saved to: {csv_path}")
    ...
    async def run_audit(self):
        ...
        try:
            ...
            print("="*60)
            print(f"[REPORT] Full Report: {report_path}")
            print(f"[DATA] CSV Summary: {csv_path}")
