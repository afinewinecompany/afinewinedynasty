...
### Agent Model Used
Claude Code (Opus 4.1) - Full Stack Developer Agent "James" (QA Fix Implementation)
...
- `apps/api/app/api/api_v1/endpoints/users.py` - New user profile and GDPR endpoints
...
- `apps/api/app/services/password_reset_service.py` - New password reset service
